...
class MainActivityViewModel(
        ...
        state.addSource(appsState) { it?.let { update ->
            ...
            when (update) {
                ...
                is AppDatabaseEntriesSynced -> {
                    ...
                    // Remaining states carry no stateful variables to capture here.
                }
            }
    ...
    private fun handleSessionPreparationState(newState: SessionStartupState) {
        ...
        return when (newState) {
            ...
            is SessionIsMissingFilesystem -> {
                // The session's filesystem was deleted; recover instead of crashing.
                postIllegalStateWithLog(SessionFilesystemMissing)
            }
...
object SessionFilesystemMissing : IllegalState()
...
class MainActivityViewModelFactory(private val appsStartupFsm: AppsStartupFsm, private val sessionStartupFsm: SessionStartupFsm) : ViewModelProvider.Factory {
